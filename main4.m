...
%corrected the train_data with randomperm
clear all
close all
...
mean(F_Score_3(23,:))
std(F_Score_3(23,:))
mean(Sensitivity_3(23,:))
std(Sensitivity_3(23,:))


%% Evaluation
clear all;
close all;
cd('C:\Users\SPK Karri\Desktop\Retina Med IA - Copy\Confusion')
Test = 50;
Train = 50;
